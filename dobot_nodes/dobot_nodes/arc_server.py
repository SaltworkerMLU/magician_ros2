...
class DobotArcServer(Node):
    ...
    async def execute_callback(self, goal_handle):
        ...
        #self.get_logger().info(f'Circumference: {self.circumference_point}')
        #self.get_logger().info(f'Ending: {self.ending_point}')
        ...
        while not (DobotArcServer.is_goal_reached(self.ending_point, self.dobot_pose, 0.2) and DobotArcServer.is_pose_stable(self.pose_arr)):
