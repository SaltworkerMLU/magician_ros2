...
class HomingService(Node):
    ...
    def __init__(self):
        ...
        self.parameter_descriptor = ParameterDescriptor(description='Position where Dobot finishes homing procedure expressed in Cartesian coordinates x, y, z, r.', 
                                                        additional_constraints = "Target position must be within Dobot's range! The unit is millimeters.")
