...
class DobotPTPServer(Node):
    ...
    def __init__(self):
        ...
        self._action_server = ActionServer(
            self,
            PointToPoint,                               # The Action Server node (this class is the Action)
            'PTP_action',                               # The name of the Action connecting the two nodes
    ...
    def destroy(self):
        ...
        super().destroy_node()          # Destroy the node associated with the action
